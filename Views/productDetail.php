...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <a href="index.php?p=addPanier&idProduct=<?php echo $selectWithId['id'] ?>&nameProduct=<?php echo $selectWithId['name'] ?>&brandProduct=<?php echo $selectWithId['marque'] ?>&qteProduct=1&priceProduct=<?php echo $selectWithId['price'] ?>"
               class="btn btn-success">Acheter</a>
        </div>
