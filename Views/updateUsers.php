                ...
                <form id="contact-form" class="form col-xs-4 col-xs-offset-2" method="POST" role="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                               value="<?= $updateUsers[0]['name'] ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="marque">Nom</label>
                        <input type="text" class="form-control" value="<?= $updateUsers[0]['last_name'] ?>"
                               placeholder="Nom" name="last_name">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="price">Mail</label>
                        <input type="email" class="form-control" value="<?= $updateUsers[0]['mail'] ?>"
                               placeholder="Mail" name="mail">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="size">Telephone</label>
                        <input type="number" value="<?= $updateUsers[0]['phone'] ?>" class="form-control"
                               placeholder="Telephone" name="phone">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="ref">Mot de Passe</label>
                        <input class="form-control" type="password" value="<?= $updateUsers[0]['password'] ?>"
                               placeholder="Mot de Passe" name="password">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="ref">Rue</label>
                        <input class="form-control" type="text" value="<?= $updateUsers[0]['street'] ?>"
                               placeholder="Rue" name="street">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="ref">Code Postal</label>
                        <input class="form-control" type="text" value="<?= $updateUsers[0]['zip_code'] ?>"
                               placeholder="Code postal" name="zip_code">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="ref">Ville</label>
                        <input class="form-control" type="text" value="<?= $updateUsers[0]['city'] ?>"
                               placeholder="Ville" name="city">
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="ref">Pays</label>
                        <input class="form-control" type="text" value="<?= $updateUsers[0]['country'] ?>"
                               placeholder="Pays" name="country">
                    </div>
